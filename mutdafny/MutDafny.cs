...
public class MutDafny : PluginConfiguration
{
    ...
    private bool IsValidOperator(string operatorName) {
        return operatorName == "AOR" || operatorName == "ROR" || operatorName == "COR" || operatorName == "LOR" ||
               ...
               operatorName == "LVR" || operatorName == "EVR" || operatorName == "VER" || operatorName == "ELR" || 
               operatorName == "LSR" || operatorName == "LBI" || operatorName == "MRR" || operatorName == "MAP" || 
               operatorName == "MNR" || operatorName == "MCR" || operatorName == "MVR" || operatorName == "SAR" || 
               operatorName == "CIR" || operatorName == "CUS" || operatorName == "CBR" || operatorName == "CBE" || 
